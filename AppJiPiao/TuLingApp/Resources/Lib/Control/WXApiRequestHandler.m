 ...
 */
+ (void)wxPayWithPartnerId:(NSString *)partnerId prepayId:(NSString *)prepayId nonceStr:(NSString *)nonceStr timeStamp:(int)timeStamp sign:(NSString *)sign
{
   // #import "WXApi.h"
     BOOL isHave=[WXApi isWXAppInstalled];
    if (isHave) {
        //调起微信支付
    ...
    }else
    {
        ...
        [MBProgressHUD showError:@"请先安装微信客户端"];
    }
    
   
}

+ (NSString *)jumpToBizPay:(NSString *)URLString {
