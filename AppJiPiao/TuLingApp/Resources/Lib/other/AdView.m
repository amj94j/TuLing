...
- (void)setPageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle
{
    ...
    //_pageControl.currentPageIndicatorTintColor = LCRGBACOLOR(242, 89, 76, 1.0);
    _pageControl.currentPageIndicatorTintColor = [UIColor colorWithRed:43/255.0 green:140.0/255 blue:242.0/255 alpha:1];
