...
- (void) send_mobile_number_to_server:(verification_button *)maleAndFemale
{
    ...
    if (self.textfield.text.length > 0) {
        NSDictionary *params = @{@"mobile":self.textfield.text};
        [NetAccess getJSONDataWithUrl:Get_Code parameters:params WithLoadingView:NO andLoadingViewStr:nil success:^(id responseObject) {
