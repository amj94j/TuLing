...
//    loginBtn = [LXTControl createButtonWithFrame:CGRectMake(15, HEIGHT-232*HEIGHT/667-40, 100*WIDTH/375, 40) ImageName:@"" Target:self Action:@selector(loginbutton:)Title:@"登录"];
//    loginBtn.layer.masksToBounds=YES;
//    loginBtn.layer.cornerRadius=2.5;
//    loginBtn.backgroundColor = [UIColor whiteColor];
//    loginBtn.layer.borderWidth = 0.5;
//    loginBtn.layer.borderColor = RGBCOLOR(1, 126, 68).CGColor;
//    loginBtn.alpha=0.9;
//    loginBtn.titleLabel.font = [UIFont boldSystemFontOfSize:18];
//    [loginBtn setTitleColor:RGBCOLOR(1, 126, 68) forState:UIControlStateNormal];
//    loginBtn.tag=3000;
