...
-(void)sendEmail
{
    ...
    [NetAccess getJSONHeaderWithUrl:kquickSendEmail parameters:params WithLoadingView:YES andLoadingViewStr:@"正在发送..." success:^(id responseObject) {
        NSMutableDictionary *dic1 ;
        dic1 = [responseObject objectForKey:@"header"];
        NSString *code = [NSString stringWithFormat:@"%@",dic1[@"code"]];
        if ([code isEqualToString:@"0"]) {
...
-(void)quitCommitRequest
{
    ...
    [NetAccess getJSONDataWithUrl:kquickLogin  parameters:params WithLoadingView:YES andLoadingViewStr:@"登录中..." success:^(id responseObject) {
        NSMutableDictionary *dic1 ;
        dic1 = [responseObject objectForKey:@"header"];
        NSString *code = [NSString stringWithFormat:@"%@",dic1[@"code"]];
        if ([code isEqualToString:@"0"]) {
